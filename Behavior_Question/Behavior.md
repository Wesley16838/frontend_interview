...
## Why Front-End Developer?
    ...
    There are several reasons why I choose Front-End Developer. First of all, I am eager to learn new technology and there are always lots of chances to learn new tech as a front-end developer. For example,I worked with a team to visualize real-time data using React.js and D3.js which are unfamiliar tech stack for me and which means it was a good opportunity for me to learn.
    Secondly, presenting the application makes me feel a sense of achievement and give me more energy for learning. For instantce, I present the dashboard to customer in Interntional exhibitoin when I was intern at Advantech and I was so pround of my team.
    Last but not least, I am a problem-solver and be willing to provide solution to improve any issues! For example, I participated global hachathon and worked with 3 people to create a platform to deal with the shortage of daily supplies during Coronavirus Pandemic.
...
6. #### Pround Project
   ...
   - PriCov
     ...
     - Online-Shopping is more popular then office shopping recently becasue of convenience. Normally customers use price comparison apps and websites to find the best price for the product they’re looking to buy. However, they still take lots of time on analysing. Therefore, since images are much easier to understand, I would like to provide a solution to visualize real-time products data to save users time on comparing. I was responsible for visualizing real-time products data using React and d3.js and mining data and from e-commerce website such as Amazon, eBay and Bestbuy using Python and Seleium. As a result, we not only successfully deployed it to the Cloud but also received positive feedback from professor.
     - The most difficult part is deploying mining server API to Heroku because there was not lots of document show how to deploy a mining server API to Heroku. The method we use is using Selenium to open the chrome browser and visit it. Thus, the issue was how to open chrome on the cloud instead of the local environment. The first thing I did was keeping reading document and using Stack Overflow. Then add arguments in the mining files so that web driver could open the chrome successfully. As a result, I successfully deploy it to Heroku and could be called by my website
     - What I learned is how to solve the issue. First of all, clarifying the issue to narrowed the issues down. Then, list all possible keywords and google it. Last but not least, keep positive and try it again and again!

   - HeartTrade

     - I took the initiative to participate online Global Hackathon which encourage people to provide solutions to improve issue related to the COVID-19. Thus, after communication with my team, we decide to create a daily supplies exchange platform to deal with the shortage of supplies DURING coronavirus pandemic. I was responsible for whole front-end side includes Posting, accepting and showing request on Google Map using React Hooks and Context API. Although we didn't win the award, we still learned lots of thing such as how to work with people who are in different time zone remotely.
