...
- Collaboration skills: As a Software Engineer, I not only just sit in front of the desk but also need to communicate with people from different such as UI designer. For example, I am responsible for developing gaming Keyboard Interface and front-end features. I need to discussed with the backend developer and UI designer. To minimize the gap between of them and make sure we speak same language, I always take time on learning UI/UX and backend concept to improve efficiency of communication. After all,A good collaboration could maximize the benefit for company
- Curiosity and eagerness: As a Software Engineer, if I stop learning, I stop growing. With techology keep changing, we should keep updating knowledge in our brain. The skills we used may not suitable for the new project. For example, I learned JavaScript before and use plain JavaScript to develop the whole UI page. However, after I read latest technical article, I found that using React could not only break UI into reusable components, but improve performance of application by avoiding unnecessary re-render! That's why I started to learn React.js
  **[⬆ Back to Top](#question)**
