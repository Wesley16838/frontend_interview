...
6. #### Challenge Project
   ...
   - PriCov
     ...
     - Online-Shopping is more popular then office shopping recently becasue of convenience. Normally customers use price comparison apps and websites to find the best price for the product they’re looking to buy. However, they still take lots of time on analysing. Therefore, since images are much easier to understand, we would like to provide a solution to visualize real-time products data to save users time on comparing. I was responsible for visualizing real-time products data using React and d3.js and mining data and from e-commerce website such as Amazon, eBay and Bestbuy using Python and Seleium. As a result, we not only successfully deployed it to the Cloud but also received positive feedback from professor.
     - The most difficult part is deploying mining server API to Heroku because there was not lots of document show how to open chrome browser on Heroku. The method we use to mine data is using Selenium to open the chrome browser and visit it by url user provided. Thus, the issue was how to open chrome on the cloud instead of the local environment. The first thing I did was keeping reading document and using Stack Overflow. Then I try to add arguments in the mining files so that web driver could open the chrome successfully. As a result, I successfully deploy it to Heroku and could be called by my website
...
7. #### Pround Project
   ...
   - Advantech
     ...
     - I felt a sense of achievement during the intern at Advantech because we had chance to show we have already done to real customer in the international exhibition and get the positive feedback from customer! I am really pround of this project becasue it not only improve my technical skill but also soft skill!
